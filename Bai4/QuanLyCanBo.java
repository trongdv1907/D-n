...
class CanBo {
    ...
    private String khoaPhongBan;
    private String trinhDo;
    private int phuCap;
    private int soTietDaySoNgayCong;
    private float heSoLuong;

    public CanBo(String hoTen, String khoaPhongBan, String trinhDo, int phuCap, int soTietDaySoNgayCong, float heSoLuong) {
        this.hoTen = hoTen;
        this.khoaPhongBan = khoaPhongBan;
        this.trinhDo = trinhDo;
        this.phuCap = phuCap;
        this.soTietDaySoNgayCong = soTietDaySoNgayCong;
    ...
    public String getKhoaPhongBan() {
        return khoaPhongBan;
    }

    public void setKhoaPhongBan(String khoaPhongBan) {
        this.khoaPhongBan = khoaPhongBan;
    }
    ...
    public int getSoTietDaySoNgayCong() {
        return soTietDaySoNgayCong;
    }

    public void setSoTietDaySoNgayCong(int soTietDaySoNgayCong) {
        this.soTietDaySoNgayCong = soTietDaySoNgayCong;
    }
    ...
    public String toString() {
        return "CanBo{" +
                ...
                ", trinhDo='" + trinhDo + '\'' +
                ", phuCap=" + phuCap +
                ", soTietDaySoNgayCong=" + soTietDaySoNgayCong +
                ", heSoLuong=" + heSoLuong +
                '}';
    }
}
